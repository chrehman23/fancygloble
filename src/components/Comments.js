                        ...
                        return (
                            <div className='px-2'>
                                <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3"  >
                                    <img src={data.comment_by && data.comment_by.profile_photo ? `${process.env.REACT_APP_BASE_URL}/${data.comment_by && data.comment_by.profile_photo}` : "assets/images/user.png"} alt="user" class="w40 position-absolute left-0" />
                                    <h5 class="font-xsss text-grey-900 mb-1 mt-0 fw-700 d-block">{data.comment_by && data.comment_by.name}
                                        ...
                                        </span></h5><h6 class="text-grey-500 fw-500 font-xssss lh-4">{data.description}</h6>
                                </div>
                            </div>
                        )
                    })}
