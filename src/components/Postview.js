                    ...
                    <>
                        <div className="card-body d-block p-0 mb-3">
                            <div className="row ps-2 pe-2 position-relative">
                                <div className="col-sm-12 p-1"><img src={BlurBackground} className="rounded-3 w-100" alt="post" /></div>
                                <div className='paidPostSeciton'>
                                    <div className='d-flex align-items-center justify-content-center'>
                                        <p className='mb-0 fw-500   lh-26 font-xssss'>Paid post</p>
                    ...
                    <>
                        ...
                        <div className="card-body d-flex p-0">
                            ...
                            >
                                ...
                                <span className="d-none-xss">{this.props.allData && this.props.allData.emoji_count + this.state.EmojisCount} Liks</span>
                            </div>
                            <div className="d-flex cursor-pointer align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"
                                onClick={() => {
                                    this.setState({
