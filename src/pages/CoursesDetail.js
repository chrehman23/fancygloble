                ...
                <div className="main-content right-chat-active">
                    <div className={this.state.apiLoader ? "px-0 middle-sidebar-bottom bg-white" :"px-0 middle-sidebar-bottom course_details_bg"}>
                        <div className="w-100">
                            ...
                            {false && !this.state.loadingCourse && (
                                <>
                                    <div className="px-3 mb-3 border-0 card">
                                        <div className="rounded row bgthwh">
                                            <div className="col-7">
                                                <div className="p-4 border-0 card-body w-100 bgthwh d-flex rounded-3">
                                                    ...
                                                    <h4 className="mt-2 mb-0 text-white font-xs fw-600 ms-4"> Course Details</h4>
                                                </div>
                                                <h1 className='mb-0 text-white fw-900 ms-4' >{this.state.titleInput}</h1>
