                                        ...
                                        {this.state.courses.map((value, index) => (
                                            ...
                                            <div key={index} className="col-lg-4 col-md-6" >
                                                <div className="card w-100 border-0 mt-4 shadow-xss pb-3">
                                                    <div className="card-image w-100 cardImgesmd p-0 text-center bg-greylight rounded-3 mb-2">
                                                    ...
                                                    <div className="card-body w-100 p-0 px-2 ">
                                                        ...
                                                        <div className="d-flex justify-content-between">
                                                            <div>
                                                                ...
                                                                <span className='bg-gray rounded'>{value.publish?"Publish":"Unpublish"}</span>
                                                            </div>
                                                            <div>
